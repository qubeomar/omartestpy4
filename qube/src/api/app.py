...
from qube.src.api.omartestpy4controller import omartestpy4Controller
from qube.src.api.omartestpy4controller import omartestpy4ItemController
from qube.src.api.versioncontroller import omartestpy4ItemVersionController
...
api.add_resource(omartestpy4ItemVersionController, '/v1/omartestpy4/version')
api.add_resource(omartestpy4Controller, '/v1/omartestpy4')
api.add_resource(omartestpy4ItemController, '/v1/omartestpy4/<string:entity_id>')

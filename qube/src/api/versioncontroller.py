...
from qube.src.api.swagger_models.omartestpy4 import VersionModel
...
class omartestpy4ItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(omartestpy4ItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['omartestpy4'],
            'description': 'omartestpy4 Version operation',
